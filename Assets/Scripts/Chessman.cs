...
public class Chessman : MonoBehaviour
{
    ...
    public void MovePlateSpawn(int matrixX, int matrixY)
    {
        ...
        //   GameObject.FindObjectOfType<BoardPlayer>().callMove(gameObject.GetComponent<PhotonView>().ViewID.ToString(),mp.name,matrixX,matrixY);
    ...
    public void MoveObj(bool attack,int matrixX,int matrixY)
    {
        ...
        controller.GetComponent<Game>().SetPositionEmpty(GetXBoard(),
           GetYBoard());
